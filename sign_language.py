...
#getting the landmark tip position and drawing blue circle
    ...
    if Im_list [tip] .x < lm_list [tip - 3].X:
...
#checking if the thumb is up
        if Im_list[thumb_tip].y < lm_list[thumb_tip-1] .y < lm_list[thumb_tip-2] .y:
            print ("LIKE")
            cv2 . putText(ing , "LIKE", (20,30), cv2. FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0) , 3)
